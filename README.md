...
## Installation
Pour l'instant pas de version installable en .exe ou .msi de l'application, mais utilisable après avoir installé les dépendances (Requirements.txt) et configuré un environnement virtuel.
